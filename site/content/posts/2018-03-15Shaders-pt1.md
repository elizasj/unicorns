...
In Threejs you have materials (which are basically 3D shapes), to which you can apply textures (which are basically like skins), “inside” which you can store a shader (which is basically …like skin pigment? I guess?), which you can then display on the screen.
...
This part is pretty straight forward, especially if you followed along in my past <a href="<a href=“https://www.unicornsfartpixels.com/posts/2018-01-01fftthree/“ target="_blank"">Audio w/Three.js post</a> - you’re basically importing a 3D object, creating a grid and rendering that object in each of the grid spaces. 
...
And now you have a working render target \o/! Your Three.js project is officially primed and ready for some shaders, which we'll get to in the next post. I'll go over how to create a custom shader using two different code implementation methods. 
